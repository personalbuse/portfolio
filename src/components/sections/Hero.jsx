...
const Hero = () => {
  ...
  useEffect(() => {
    // Initial entry animation (assembly)
    ...
    // Explode parts in 3D space and untype text
    scrollTl
      .to(scrollObj, {
        len: 0,
        ease: 'none',
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[60vw] h-[60vw] bg-neon/5 blur-[100px] rounded-full -z-10 pointer-events-none"></div>
    </section>
  );
};
